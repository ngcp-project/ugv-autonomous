...
from auto_ctrl_publisher import auto_ctlPublisher
from auto_ctrl_subscriber import auto_ctlSubscriber
...
def main():
    ...
    if args.pub:
        print(f"Running auto_ctlPublisher on domain {args.domain}")
        auto_ctlPublisher.run_publisher(
            domain_id=args.domain,
            sample_count=args.sample_count)
    else:
        print(f"Running auto_ctlSubscriber on domain {args.domain}")
